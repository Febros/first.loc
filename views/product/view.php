...
<section>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <span>
									...
									<a href="<?= Url::to(['cart/add','id' => $product->id]) ?>" id="putBtn" data-id="<?= $product->id ?>" class="btn btn-default  cart add-to-cart">
   ...
   <!--Вывод контента через визуальный редактор--> <?= $product->content ?>
